...
const DemoSubjectCards = () => {
  ...
  const DraggableForm = ({ form, index }) => {
    ...
    return (
      <div key={form.id} className="mb-[16px]" ref={setNodeRef} style={style}>
        <div className="bg-[#f9fafb] border border-[#D0D5DD] rounded">
          <div className="p-4 flex justify-between items-center bg-[#EAECF0]">
            <button {...attributes} {...listeners} className="text-gray-600 text-xl font-bold">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
              ...
              >
                <path
                  d="M10.0002 4.99992C10.4604 4.99992 10.8335 4.62682 10.8335 4.16659C10.8335 3.70635 10.4604 3.33325 10.0002 3.33325C9.53993 3.33325 9.16683 3.70635 9.16683 4.16659C9.16683 4.62682 9.53993 4.99992 10.0002 4.99992Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M10.0002 10.8333C10.4604 10.8333 10.8335 10.4602 10.8335 9.99992C10.8335 9.53968 10.4604 9.16659 10.0002 9.16659C9.53993 9.16659 9.16683 9.53968 9.16683 9.99992C9.16683 10.4602 9.53993 10.8333 10.0002 10.8333Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M10.0002 16.6666C10.4604 16.6666 10.8335 16.2935 10.8335 15.8333C10.8335 15.373 10.4604 14.9999 10.0002 14.9999C9.53993 14.9999 9.16683 15.373 9.16683 15.8333C9.16683 16.2935 9.53993 16.6666 10.0002 16.6666Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M15.8335 4.99992C16.2937 4.99992 16.6668 4.62682 16.6668 4.16659C16.6668 3.70635 16.2937 3.33325 15.8335 3.33325C15.3733 3.33325 15.0002 3.70635 15.0002 4.16659C15.0002 4.62682 15.3733 4.99992 15.8335 4.99992Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M15.8335 10.8333C16.2937 10.8333 16.6668 10.4602 16.6668 9.99992C16.6668 9.53968 16.2937 9.16659 15.8335 9.16659C15.3733 9.16659 15.0002 9.53968 15.0002 9.99992C15.0002 10.4602 15.3733 10.8333 15.8335 10.8333Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M15.8335 16.6666C16.2937 16.6666 16.6668 16.2935 16.6668 15.8333C16.6668 15.373 16.2937 14.9999 15.8335 14.9999C15.3733 14.9999 15.0002 15.373 15.0002 15.8333C15.0002 16.2935 15.3733 16.6666 15.8335 16.6666Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M4.16683 4.99992C4.62707 4.99992 5.00016 4.62682 5.00016 4.16659C5.00016 3.70635 4.62707 3.33325 4.16683 3.33325C3.70659 3.33325 3.3335 3.70635 3.3335 4.16659C3.3335 4.62682 3.70659 4.99992 4.16683 4.99992Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M4.16683 10.8333C4.62707 10.8333 5.00016 10.4602 5.00016 9.99992C5.00016 9.53968 4.62707 9.16659 4.16683 9.16659C3.70659 9.16659 3.3335 9.53968 3.3335 9.99992C3.3335 10.4602 3.70659 10.8333 4.16683 10.8333Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
                <path
                  d="M4.16683 16.6666C4.62707 16.6666 5.00016 16.2935 5.00016 15.8333C5.00016 15.373 4.62707 14.9999 4.16683 14.9999C3.70659 14.9999 3.3335 15.373 3.3335 15.8333C3.3335 16.2935 3.70659 16.6666 4.16683 16.6666Z"
                  stroke="#344054"
                  strokeWidth="1.66667"
                  strokeLinejoin="round"
                />
          ...
          <div className="p-4">
            ...
            <div className="flex space-x-4 pb-[24px]">
              {form.avatars.length < maxAvatars && (
                <label className="w-[256px] h-[144px] border-2 border-[#A16A99] border-dashed rounded-lg p-[13.5px] flex items-center justify-center cursor-pointer hover:bg-gray-100 transition-colors">
                  <input
                    type="file"
                    accept="image/*"
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <feBlend
                            ...
                            result="effect1_dropShadow_4309_114441"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_4309_114441"
                            result="shape"
                          />
                        </filter>
                      </defs>
...
export default DemoSubjectCards;
