...
const DemoTitleSection = () => {
    const [avatars, setAvatars] = useState(["/avatar1.jpg", "/avatar2.jpg", "/avatar3.jpg"]);
  ...
  return (
    <div className="w-[720px] mx-auto p-6 bg-white rounded-lg shadow border space-y-8 text-black">
      ...
      {/* Avatars */}
      <div className="space-y-4">
        <h3 className="font-medium ">Bottom-left Avatars and Subtitle</h3>
      ...
      {/* Social Links */}
      <div className="space-y-4">
        <h3 className="font-medium ">Links to Socials</h3>
        {[
