                ...
                <div className='space-y-[20px]'>
                    ...
                    />
                        <div className="mt-[16px]">
                            <p className="text-sm font-medium text-[#344054]">Image displayed when the page is shared </p>
                            <div className="flex space-x-4 mt-2">
                                ...
                                <label
                                    ...
                                    className="w-[240px] h-[240px] border-2 border-[#A16A99] border-dashed rounded-lg p-[13.5px] flex items-center justify-center cursor-pointer hover:bg-gray-100 transition-colors"
                                >
                                    <input
                                    type="file"
                                    accept="image/*"
                                    ...
                                    or drag and drop <br /> (Max: 480x480px)
                                    </div>
                                </label>
                                )}
        ...
        <div className='mb-6 px-6'>
            <div className="p-4 bg-[#f9fafb] border border-[#D0D5DD] rounded ">
                ...
                <div className='space-y-[20px]'>
                    ...
                    />
                        <div className="mt-[16px]">
                            <p className="text-sm font-medium text-[#344054]">Image for Twitter shares </p>
                            <div className="flex space-x-4 mt-2">
                                {avatars.length < maxAvatars && (
                                <label
                                    onDrop={handleFileDrop}
                    ...
                    <div className='my-4'>
                        <Dropdown
                        label="Content Type"
                        options={['Summary', 'Website', 'Articel']}
                        value={selectedOption}
                        onChange={setSelectedOption}
                        />
                    </div>
